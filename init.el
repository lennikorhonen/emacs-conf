...
(custom-set-variables
 ...
 '(package-selected-packages
   '(py-autopep8 python-mode use-package magit tagedit rainbow-delimiters projectile smex ido-completing-read+ cider clojure-mode-extra-font-locking clojure-mode paredit exec-path-from-shell)))
(custom-set-faces
