# Emacs config that i use
This config is from resources of a book: Clojure for Brave and True by Daniel Higginbotham
but has some minor changes for my own use

The following stuff is from the original README file
